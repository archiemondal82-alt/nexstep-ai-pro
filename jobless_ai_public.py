...
class UIComponents:
    ...
    def apply_custom_css():
        ...
        <style>
            ...
            .stApp { background:#060b14!important; color:white!important; font-family:'Space Grotesk',sans-serif!important; }
            @media (hover: hover) and (pointer: fine) { .stApp { cursor: none!important; } }
